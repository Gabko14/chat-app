...
namespace Tests
{
    public class MessageRepositoryTests
    {
        ...
        {
            // Arrange
            var message = new Message { MessageId = 1, Content = "Hello, World!", Sender = "gabo" };
        ...
        {
            // Arrange
            var message1 = new Message { MessageId = 1, Content = "Hello, World!", Sender = "gabo" };
            var message2 = new Message { MessageId = 2, Content = "Hello, xUnit!", Sender = "mo" };
        ...
        public async Task UpdateMessageAsync_ShouldUpdateMessage()
        {
            ...
            var updatedMessage = new Message { MessageId = 1, Content = "Hello, Updated World!", Sender = "gabo" };
